            ...
            "parts": [
                {
                    "text": (
                        ...
                        "The target form needs: bathroomsCount as total bathrooms; bedroomsCount as total bedrooms; "
                        ...
                        "houseStyle as the building type or architectural style; basement as basement development; "
                        "L_basement2_status as the second basement, suite, or lower-level status if a second basement/status is present. "
                        ...
                        "Use assessmentClass as residential or condo when clear. Omit fields that are not present or uncertain."
                    )
                },
                {
                    "inlineData": {
